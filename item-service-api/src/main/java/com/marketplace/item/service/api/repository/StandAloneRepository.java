...
public class StandAloneRepository implements RedisRepository, Constants {
    ...
    public Mono<ItemUpdatePipeline> invalidateCacheOnItemUpdate(ItemUpdatePipeline pipeline) {
        ...
        ByteBuffer byteKey = createKeyFromString(com.marketplace.item.service.api.common.Constants.ITEMS_COLLECTION_SET, String.valueOf(details.getBrandId()));
    ...
    public Mono<Void> cleanupCacheOnDeletedBrand(long brandId) {
        ByteBuffer byteKey = createKeyFromString(com.marketplace.item.service.api.common.Constants.ITEMS_COLLECTION_SET, String.valueOf(brandId));
    ...
    public Mono<ItemUpdatePipeline> cleanupCacheOnDeletedItem(ItemUpdatePipeline pipeline) {
        ...
        ByteBuffer byteKey = createKeyFromString(com.marketplace.item.service.api.common.Constants.ITEMS_COLLECTION_SET, String.valueOf(key));
